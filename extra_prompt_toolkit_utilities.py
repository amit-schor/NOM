...
def make_ConstantOptions_Completer_and_Validator(options, preferred_option=None,
                                                 preferred_option_styles=("bg:ansibrightgreen fg:ansiblack",
                                                                          "bg:ansigreen fg:ansiwhite"),
                                                 b_complete_only_if_requested=False):
...
class ConstantOptionsCompleter(Completer):
    def __init__(self, options, preferred_option=None,
                 preferred_option_styles=("bg:ansibrightgreen fg:ansiblack", "bg:ansigreen fg:ansiwhite"),
                 b_complete_only_if_requested=False):
        ...
        if complete_event.completion_requested or not self.b_complete_only_if_requested:
            for o in self.options:
                if o == self.preferred_option:
                    yield Completion(o, -document.cursor_position, style=self.preferred_option_styles[0],
                                     selected_style=self.preferred_option_styles[1])
                else:
